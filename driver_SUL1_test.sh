...
#$ -cwd
#$ -N msa_pacbio
#$ -o /net/dunham/vol2/Cindy/pacbio_git/200518_subassembly_pairwise/Subassembly_PB_IndelCorrection/test
#$ -e /net/dunham/vol2/Cindy/pacbio_git/200518_subassembly_pairwise/Subassembly_PB_IndelCorrection/test
